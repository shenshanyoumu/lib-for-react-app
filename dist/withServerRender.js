(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'react', 'hoist-non-react-statics', './BaseComponent', './utils/getDisplayName', './utils/isBrowserSide'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('react'), require('hoist-non-react-statics'), require('./BaseComponent'), require('./utils/getDisplayName'), require('./utils/isBrowserSide'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.hoistNonReactStatics, global.BaseComponent, global.getDisplayName, global.isBrowserSide);
    global.withServerRender = mod.exports;
  }
})(this, function (exports, _react, _hoistNonReactStatics, _BaseComponent2, _getDisplayName, _isBrowserSide) {
  'use strict';
