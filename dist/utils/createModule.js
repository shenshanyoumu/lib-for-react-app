(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'immutable', 'lodash', 'redux', './moduleUI', './createReducer'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('immutable'), require('lodash'), require('redux'), require('./moduleUI'), require('./createReducer'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.immutable, global.lodash, global.redux, global.moduleUI, global.createReducer);
    global.createModule = mod.exports;
  }
})(this, function (exports, _immutable, _lodash, _redux, _moduleUI, _createReducer) {
  'use strict';
  ...
  exports.default = function (_ref) {
    ...
    var isImmutable = _immutable2.default.Iterable.isIterable(state);
    var needInjectUI = isImmutable ? state.has('ui') : Object.prototype.hasOwnProperty.call(state, 'ui');
    ...
    if (needInjectUI) {
      UIReducers = isImmutable ? (0, _moduleUI.getUIReducers)(namespace) : (0, _moduleUI.getUIReducersImmer)(namespace);
