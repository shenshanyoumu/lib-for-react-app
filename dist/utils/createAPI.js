(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'lodash/isArray', '../fetchHelper/consts', './processHeaders'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('lodash/isArray'), require('../fetchHelper/consts'), require('./processHeaders'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.isArray, global.consts, global.processHeaders);
    global.createAPI = mod.exports;
  }
})(this, function (exports, _isArray, _consts, _processHeaders) {
  'use strict';
