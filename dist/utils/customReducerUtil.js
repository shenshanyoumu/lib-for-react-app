(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'immutable', 'lodash/isFunction', './getTimestamp', './customStatusUtil'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('immutable'), require('lodash/isFunction'), require('./getTimestamp'), require('./customStatusUtil'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.immutable, global.isFunction, global.getTimestamp, global.customStatusUtil);
    global.customReducerUtil = mod.exports;
  }
})(this, function (exports, _immutable, _isFunction, _getTimestamp, _customStatusUtil) {
  'use strict';
