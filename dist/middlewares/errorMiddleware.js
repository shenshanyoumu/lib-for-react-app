(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', '../fetchHelper/fetchException', '../fetchHelper/consts/exceptionTypes', '../actions/systemError'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('../fetchHelper/fetchException'), require('../fetchHelper/consts/exceptionTypes'), require('../actions/systemError'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.fetchException, global.exceptionTypes, global.systemError);
    global.errorMiddleware = mod.exports;
  }
})(this, function (exports, _fetchException, _exceptionTypes, _systemError) {
  'use strict';
