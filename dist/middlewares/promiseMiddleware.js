(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', '../utils/isPromise', '../utils/customActionUtil', '../actions/systemLoading', '../actions/systemError', './promiseCounter'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('../utils/isPromise'), require('../utils/customActionUtil'), require('../actions/systemLoading'), require('../actions/systemError'), require('./promiseCounter'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.isPromise, global.customActionUtil, global.systemLoading, global.systemError, global.promiseCounter);
    global.promiseMiddleware = mod.exports;
  }
})(this, function (exports, _isPromise, _customActionUtil, _systemLoading, _systemError, _promiseCounter) {
  'use strict';
